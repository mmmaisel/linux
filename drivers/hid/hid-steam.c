...
static int steam_sensors_register(struct steam_device *steam)
{
	...
	sensors->name = (steam->quirks & STEAM_QUIRK_WIRELESS) ? "Wireless Steam Controller Motion Sensors" :
		(steam->quirks & STEAM_QUIRK_DECK) ? "Steam Deck Motion Sensors" :
	...
	input_abs_set_res(sensors, ABS_X, 1024);
	input_abs_set_res(sensors, ABS_Y, 1024);
	input_abs_set_res(sensors, ABS_Z, 1024);
	...
	input_abs_set_res(sensors, ABS_RX, 1024);
	input_abs_set_res(sensors, ABS_RY, 1024);
	input_abs_set_res(sensors, ABS_RZ, 1024);
